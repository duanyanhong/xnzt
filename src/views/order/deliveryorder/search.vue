      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <div v-if="scope.row.englishName=='examineTime'" class="search-input">
            {{scope.row.chineseName}}：
            <date-range-picker v-model="searchData.examineTime" disabled :clearable="false" style="width: 350px !important;" class="date-item" />
          </div>
        </template>
      </el-table-column>
      <el-table-column
...
<script>
  export default {
    ...
    data() {
      return {
        searchData: {soCode: '', shCode: '', ownerId: [], shopId: [], deliveryOrderCode: '', preDeliveryOrderCode: '', preDeliveryOrderId: '', orderType: [], warehouseId: [], logicwarehouseId: [], sourcePlatformCode: [], createTime: [], placeOrderTime: [], payTime: [], sellerNick: '', buyerNick: '', vestNo: '', logisticsCode: [], expressCode: '', expressName: '', provinceId: [], cityId: [], areaId: [], orderState: [], examineTime: []},
        searchIsshow: false,
        searchContent: '',
        titlesContent: '',
        searchType: '',
