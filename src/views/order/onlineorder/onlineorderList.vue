        ...
        <el-row  style="margin-bottom: 1px;" class="crud-opts">
          ...
          <span class="crud-opts-left">
            ...
            <el-button
              ...
              @click="examineAllocation"
              plain
              v-hasPermi="['Order:OnlineOrder:Tosale']"
            >
              审核
            </el-button>
          </span>
          ...
          <span class="crud-opts-left">
            ...
            <el-button
              ...
              icon="el-icon-refresh"
              plain
              v-hasPermi="['Order:OnlineOrder:Returntime']"
              @click="handlerReturn"
            >
              接单回传平台
            </el-button>
          ...
          <pane class="splitpanes-top" min-size="35" :size="topSize">
            <u-table
              ...
              >
                ...
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="xnCode" width="120" label="新鸟单号" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="bizOrderCode" width="120" label="网店订单号" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="orderState" width="120" label="订单状态" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="tradeState" width="120" label="交易状态" />
                ...
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="sourcePlatformCode" width="120" label="来源平台" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="receiverProvince" width="120" label="收件省份" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="receiverCity" width="120" label="收件城市" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="receiverArea" width="120" label="收件区县" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="receiverTown" width="120" label="收件街道" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="receiverAddress" width="120" label="收件方地址" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="receiverSecurityMobile" width="140" label="收件人安全手机号" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="abnormalDesc" width="140" label="异常标记" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="itemsValue" width="120" label="订单总金额" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="postFee" width="120" label="运费金额" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="bizType" width="120" label="交易类型" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="returnPlatformTime"   width="150" label="接单时间" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="appointDeliveryTime" width="120" label="预约配送时间" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="appointArrivedTime" width="120" label="预计送达时间" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="esDate" width="120" label="预计到货日期" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="deliveryTime" width="120" label="应发货时间" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="buyerMessage" width="120" label="买家留言" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="placeOrderTime" width="120" label="下单时间" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="payTime" width="120" label="付款时间" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="orderCreateTime" width="120" label="发货单创单时间" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="acceptTime" width="120" label="创建时间" />
                <u-table-column :show-overflow-tooltip="true" align="center"  prop="toSaleTime" width="120" label="审核时间" />
              </u-table>
            <pagination
  ...
  export default {
    ...
    methods: {
      ...
      handlerReturn() {
        ...
        returnPlatformTime({accessToken: sessionStorage.getItem('xn_token'),id:this.ids}).then(res => {
          if(res){
            console.log(res)
      ...
      examineAllocation() {
        ...
        if (_this.ids.length < 1) {
          _this.$message({title: '错误', message: '请选择要操作的数据', duration: 3000, type: 'warning'})
          return
        }
        _this.$confirm('确定要操作选中数据吗?', '提示', {confirmButtonText: '确定', cancelButtonText: '取消', type: 'warning'}).then(() => {
          toSaleorder({id:this.ids,accessToken: sessionStorage.getItem('xn_token')}).then(res => {
            if(res){
              _this.$modal.notifySuccess(res.errMsg)
              _this.loadData()
            }
