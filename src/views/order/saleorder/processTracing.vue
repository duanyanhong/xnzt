    ...
    <div class="custom_steps" v-for="(item, index) in allSteps" :key="index">
      <div class="mid_steps">
        <el-steps align-center space="12.5rem">
          <el-step v-for="(d, i) in item.topSteps" icon="el-icon-success" :key="i"  :title="d.title"  :status="d.state==1 ? 'finish' : ''">
          </el-step>
        </el-steps>
        <el-steps align-center style="justify-content: flex-end;" space="12.5rem">
          <el-step v-for="(d, i) in item.bottomSteps" icon="el-icon-success" :key="i"  :title="d.title"  :status="d.state==1 ? 'finish' : ''">
          </el-step>
        </el-steps>
