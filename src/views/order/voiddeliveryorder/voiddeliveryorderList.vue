        ...
        <div class="crud-opts">
          <span class="crud-opts-left">
            ...
            <el-button
              ...
              @click="downMyOrder"
              plain
              v-hasPermi="['Order:Voidstockoutorder:Export']"
            >
              导出
            </el-button>
          </span>
...
<script>
  import { getVoidstockoutorderList,exportVoidsaleorder } from "@/api/order/voidstockoutorder";
  export default {
    name: 'Voidstockoutorder',
    data() {
      return {
        searchData: {
          limit: 20,
    ...
    methods: {
      ...
      loadData() {
        this.loading = true
        getVoidstockoutorderList(this.searchData).then(res => {
          if(res){
            this.loading = false
